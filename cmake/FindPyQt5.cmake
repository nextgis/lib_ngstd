...
ELSE(EXISTS PYQT5_VERSION_STR)
  ...
  IF(SIP_BUILD_EXECUTABLE)
    ...
    IF(_pyqt5_metadata)
      ...
      GET_FILENAME_COMPONENT(_pyqt5_dist_info_dir ${_pyqt5_metadata} DIRECTORY)
      GET_FILENAME_COMPONENT(_pyqt5_site_packages ${_pyqt5_dist_info_dir} DIRECTORY)
      SET(PYQT5_MOD_DIR "${_pyqt5_site_packages}/PyQt5")
