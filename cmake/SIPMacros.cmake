...
MACRO(GENERATE_SIP_PYTHON_MODULE_CODE MODULE_NAME MODULE_SIP SIP_FILES CPP_FILES)
  ...
  FOREACH (_sip_file ${SIP_FILES})
    ...
    CONFIGURE_FILE(${_sip_file} ${MODULE_SIP})
  ...
  ELSE (SIP_BUILD_EXECUTABLE)
    ...
    SET(SIPCMD ${SIP_BINARY_PATH} ${_sip_tags} -t WS_X11 -w -e ${_sip_x} ${SIP_EXTRA_OPTIONS} -j ${SIP_CONCAT_PARTS} -c ${CMAKE_CURRENT_BINARY_DIR}/${_module_path} -I ${CMAKE_CURRENT_BINARY_DIR}/${_module_path} -I ${PYQT5_SIP_DIR} ${_sip_includes} ${_configured_module_sip})
    ADD_CUSTOM_COMMAND(
      OUTPUT ${_sip_output_files}
      COMMAND ${CMAKE_COMMAND} -E echo ${message}
      COMMAND ${CMAKE_COMMAND} -E touch ${_sip_output_files}
...
MACRO(BUILD_SIP_PYTHON_MODULE MODULE_NAME SIP_FILES EXTRA_OBJECTS)
  ...
  TARGET_INCLUDE_DIRECTORIES(${_logical_name} PRIVATE ${CMAKE_CURRENT_BINARY_DIR}/${_module_path}/build ${SIP_INCLUDE_DIR} ${CMAKE_SOURCE_DIR}/src)
  ...
  ENDIF (NOT APPLE)
  TARGET_LINK_LIBRARIES(${_logical_name} ${EXTRA_LINK_LIBRARIES} Qt5::Core Qt5::Gui Qt5::Widgets)
  IF (APPLE)
  ...
  if(NOT SKIP_INSTALL_LIBRARIES AND NOT SKIP_INSTALL_ALL )
    INSTALL(TARGETS ${_logical_name} DESTINATION "${NGSTD_PYTHON_DIR}")
  endif()
